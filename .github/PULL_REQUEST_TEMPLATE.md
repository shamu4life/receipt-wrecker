...
- [ ] Every markup mode still has a markup-free fallback behind it (Hanzi tiling for text, glyph-art for pictures), and anything user-supplied that lands in markup goes through `escapeHtml`/`escapeAttr`/`cssUrl`
